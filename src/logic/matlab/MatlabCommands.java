...
final class MatlabCommands {
    ...
    static final String CHANNEL_VAR = "channel";
    ...
    static final String PLOT_SONG = String.format("plotSong(%s, %s, %s);", SAMPLE_VAR, FREQ_VAR, IMG_VAR);
    ...
    static final String RELOCATE_SONG_EMPTY = String.format("relocateSongEmpty(%s);", PLAYER_VAR);
    static final String RELOCATE_SONG = String.format("relocateSong(%s, %s);", PLAYER_VAR, START_VAR);
    static final String CHANGE_VOLUME = String.format("changeVolume(%s, %s, %s);", PLAYER_VAR, SAMPLE_VAR, LEVEL_VAR);
    static final String ANALYZE_SONG = String.format("analyzeSong(%s, %s, %s, %s, %s, %s);",
            SAMPLE_VAR, WINDOW_SIZE_VAR, HOP_SIZE_VAR, NFFT_VAR, FREQ_VAR, CHANNEL_VAR);
}
