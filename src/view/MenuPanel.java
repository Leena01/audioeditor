...
class MenuPanel extends JPanel {
    ...
    MenuPanel(MatlabHandler matlabHandler, ActionListener fb, ActionListener ufb) {
        super();
        ...
        infoLabel = new Label("Welcome! Please select a song and choose from the options below:");
