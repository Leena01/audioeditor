 ...
 * generate RMI server proxy objects for instances of audioeditor.Class1.
 */
public interface Class1Remote extends Poolable
{
     ...
     */
    public Object[] changeSpeed(Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] changeVolume(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>cutSong</code> M-function 
     ...
     * in communication with the server.
     */
    public Object[] cutSong(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>deleteSong</code> M-function 
     ...
     * in communication with the server.
     */
    public Object[] deleteSong(Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] getSongHandle(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>pauseSong</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] pauseSong(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>playSong</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] playSong(Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] relocateSong(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>resumeSong</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] resumeSong(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>stopSong</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] stopSong(Object... rhs) throws RemoteException;
